            ...
            <tr v-for="(sk, idx) in filteredSKList" :key="sk.id" class="hover:bg-blue-50/20 transition">
              ...
              <td class="py-4 px-6 text-center">
                <button 
                  ...
                  class="bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white px-3.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1 mx-auto cursor-pointer"
                >
