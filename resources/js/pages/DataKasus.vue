      ...
      <div class="w-full">
        ...
        <div class="relative">
          <input
            v-model="searchText"
            type="text"
            placeholder="Cari berdasarkan nama kasus..."
              ...
              <td class="px-6 py-4 text-xs text-center">
                <div class="flex gap-2 justify-center">
                  <button
                    ...
                    class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 flex items-center justify-center transition-all duration-200 cursor-pointer"
                    title="Edit"
                  >
